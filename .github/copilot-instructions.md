# Copilot Instructions for StateForge
StateForge automatically extracts state machines from source code, log files, API sequences, or natural language descriptions and renders them as interactive diagrams. It is a native Rust and Tauri desktop app that can export to Mermaid, DOT, SVG, or generated code in five languages.
## Code style
